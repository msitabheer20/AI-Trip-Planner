          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold mb-2">
                Your Trip to {tripPlan.destination.name}
              </h1>
      ...
      <div className="container max-w-5xl mx-auto px-4 py-8">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">₹{tripPlan.budget.total.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Per Person</span>
                      <span className="font-medium">₹{tripPlan.budget.total.toLocaleString()}</span>
                    </div>
                    <div className="mt-4">
        ...
        <div className="flex justify-between mt-12 pt-6 border-t">
          ...
          <div className="space-x-4">
            ...
            <Button className="bg-[#34e0a1] hover:bg-[#2bc889] text-black">
              Confirm & Book
            </Button>
          </div>
        </div>
